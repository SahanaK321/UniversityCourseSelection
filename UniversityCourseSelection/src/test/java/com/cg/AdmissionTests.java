...
class AdmissionTests {
	...
	public void testShowAllByCourseId() {
		...
		.thenReturn(Stream.of(new Admission(102, 112, "1", LocalDate.parse("2021-05-20"), AdmissionStatus.Applied),new Admission(103, 112, "1", LocalDate.parse("2021-05-20"), AdmissionStatus.Applied)).collect(Collectors.toList()));
