...
class ApplicantTests {
	...
	public void TestViewAllApplicantsByStatus() {
	    ...
	    (new Applicant("101","abc","9896753420","12th",78,AdmissionStatus.Applied), new Applicant("102","abc","9896752320","12th",60,AdmissionStatus.Applied),new Applicant("103","abc","9890052320","12th",60,AdmissionStatus.Applied)).collect(Collectors.toList()));
